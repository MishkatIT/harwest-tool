...
class CodechefClient:
    ...
    def get_user_submissions(self, page_index):
        # Fetch submission list for the user using CodeChef API
        ...
        for index in range(start_index, end_index):
            ...
            tags_list = ["CodeChef", "*" + str(points)]
            problem_url = CodechefClient.CONTEST_URL \
            ...
            submission_url = CodechefClient.CODE_URL \
